...
def run_single_formatter(product_input: str):
    ...
    task = Task(
        description=(
            ...
            "DESCRIPTION:\n"
            "- Write a premium, engaging, and customer-friendly description\n"
            "- MUST be 2–3 meaningful lines using real line breaks\n"
            "- Clearly explain:\n"
            "  • Fabric comfort, softness, and breathability\n"
            "  • Ideal occasions or use cases (daily wear, office, casual outings, festive, travel)\n"
            "  • Styling versatility or pairing suggestions\n"
            "- Language should be simple, informative, and confidence-building\n"
            "- Maintain a professional tone (not promotional or salesy)\n"
            "- ABSOLUTELY DO NOT include:\n"
            "  prices, currency symbols, shipping details, offers, emojis, hashtags, or sizes\n\n"
...
def run_combo_formatter(product_input: str):
    ...
    task = Task(
        description=(
            ...
            "DESCRIPTION:\n"
            "- Write an engaging, premium, buyer-focused description\n"
            "- MUST be 2–3 meaningful lines using real line breaks\n"
            "- Use 1–3 relevant, subtle emojis to improve readability (e.g., 👕✨👌)\n"
            "- Clearly describe:\n"
            "  • Fabric comfort, quality, and feel\n"
            "  • Practical benefits of buying a combo (easy rotation, better value, consistency)\n"
            "  • Ideal usage scenarios (office wear, daily wear, travel, casual outings, uniforms)\n"
            "- Language should be simple, professional, and confidence-building\n"
            "- MUST include exactly ONE standalone sentence (no emojis in this sentence):\n"
            "  'Single piece also available at ₹<Single Price + 20%>'\n"
            "- Do NOT mention any other prices, calculations, discounts, shipping, or sizes\n\n"
