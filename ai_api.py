...
def run_single_formatter(product_input: str):
    ...
    task = Task(
        description=(
            ...
            "DESCRIPTION:\n"
            "- Write an engaging, premium, customer-friendly description\n"
            "- MUST be 2–3 meaningful lines using real line breaks\n"
            "- Include useful information such as:\n"
            "  • Comfort and fabric feel\n"
            "  • Suitable occasions or use cases (daily wear, office, casual outings, festive, travel, etc.)\n"
            "  • Styling or versatility benefits\n"
            "- Tone should be professional and appealing (not salesy)\n"
            "- ABSOLUTELY DO NOT include:\n"
            "  prices, currency symbols, shipping info, offers, emojis, hashtags, or sizes\n\n"
...
def run_combo_formatter(product_input: str):
    ...
    task = Task(
        description=(
            ...
            "DESCRIPTION:\n"
            "- Write a premium, professional, value-focused description\n"
            "- MUST be 2–3 meaningful lines using real line breaks\n"
            "- Include useful information such as:\n"
            "  • Fabric comfort and quality\n"
            "  • Benefits of buying a combo (daily rotation, convenience, consistency)\n"
            "  • Suitable use cases (office wear, daily wear, travel, casual outings, uniforms, etc.)\n"
            "- MUST include exactly ONE standalone sentence:\n"
            "  'Single piece also available at ₹<Single Price + 20%>'\n"
            "- Do NOT mention any other prices, calculations, offers, shipping, or sizes\n\n"
